...
description: Use when drafting or revising human-facing prose, documentation, explanations, UI text, comments, emails, articles, summaries, or public writing where medium fit, factual discipline, specificity, tone, or AI-like regularity matters.

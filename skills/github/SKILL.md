---
name: github
description: Use when working with GitHub pull requests, PR review comments, CodeRabbit review feedback, PR checks, PR diff context, or GitHub GraphQL/API data for pull requests.
---
